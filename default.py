...
class default(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_ccc(4, firdes.low_pass(1.0, 2e6, 125e3, 25e3), 0, samp_rate)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(433e6, self.samp_rate)
        self.qtgui_waterfall_sink_x_0.set_frequency_range(433e6, self.samp_rate)
