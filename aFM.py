...
class aFM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "aFM")
        ...
        # Blocks
        ##################################################
        self._tune_range = Range(88.7, 110.1, 0.1, 102, 200)
        ...
        self._Audio_gain_range = Range(0, 100, 1, 10, 200)
        ...
        self.osmosdr_source_0 = osmosdr.source(
            args="numchan=" + str(1) + " " + 'RTL-SDR'
        )
        self.osmosdr_source_0.set_time_unknown_pps(osmosdr.time_spec_t())
        self.osmosdr_source_0.set_sample_rate(samp_rate)
        self.osmosdr_source_0.set_center_freq(tune*1e6, 0)
        self.osmosdr_source_0.set_freq_corr(0, 0)
        self.osmosdr_source_0.set_dc_offset_mode(0, 0)
        self.osmosdr_source_0.set_iq_balance_mode(0, 0)
        self.osmosdr_source_0.set_gain_mode(False, 0)
        self.osmosdr_source_0.set_gain(Audio_gain, 0)
    ...
    def set_tune(self, tune):
        self.tune = tune
        self.osmosdr_source_0.set_center_freq(self.tune*1e6, 0)
        self.qtgui_freq_sink_x_0.set_frequency_range(self.tune*1e6, self.samp_rate)
        self.qtgui_freq_sink_x_0_0_0.set_frequency_range(self.tune*1e6, self.samp_rate / 5)
    ...
    def set_Audio_gain(self, Audio_gain):
        ...
        self.osmosdr_source_0.set_gain(self.Audio_gain, 0)




def main(top_block_cls=aFM, options=None):
